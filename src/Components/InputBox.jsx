...
const InputBox = ({workData, discriptionsData, handleInputData, handleDiscriptionsData, addNotes}) => {
  return (
    <div className='h-full'>
      <div className='h-full bg-gray-800 border border-white/20 rounded-2xl p-6 shadow-lg'>
        <form className='flex flex-col gap-4 text-white h-full' onSubmit={addNotes}>
          <input
          ...
          />
          <textarea
            className='outline-none border border-white/20 rounded-lg px-4 py-3 bg-gray-900 resize-none flex-1'
